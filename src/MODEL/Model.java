...
public class Model {
    ...
    private int tahun;
    private String warna, kapasitas_mesin, transmisi;
    private int kapasitas_penumpang, kilometer;
    private String deskripsi_mobil, judul_iklan;
    private int harga, no_telefon;

    public Model(int id_mobil, int id_akun, String tanggal_post, String tipe_mobil, String merk, String model, String varian, int tahun, String warna, String kapasitas_mesin, String transmisi, int kapasitas_penumpang, int kilometer, String deskripsi_mobil, String judul_iklan, int harga, int no_telefon) {
    ...
    public int getNo_telefon() {
        return no_telefon;
    }

    public void setNo_telefon(int no_telefon) {
        this.no_telefon = no_telefon;
    }
